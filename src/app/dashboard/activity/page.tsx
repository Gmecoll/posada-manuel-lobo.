...
// Mantenemos tus rutas originales con el alias @/
    ...
    <main className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-3xl font-bold text-slate-800 font-headline">Panel de Control</h1>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          
          {/* LADO IZQUIERDO: Control de Cerraduras */}
          <div className="lg:col-span-1">
            <AdminLockPanel />
          </div>

          {/* LADO DERECHO: Historial de Actividad */}
          <div className="lg:col-span-2">
            <Card className="shadow-sm border-slate-200">
              <CardHeader className="border-b border-slate-100 bg-white">
                ...
                <CardDescription>
                  Registro de las últimas acciones en la posada.
                </CardDescription>
              </CardHeader>
